...
Revision ID: c8116eea59ad
Revises: 8fa27a5e0aee
Create Date: 2021-12-23 19:02:55.349541
...
revision = 'c8116eea59ad'
down_revision = '8fa27a5e0aee'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('labor_category', sa.String(length=20), nullable=False),
